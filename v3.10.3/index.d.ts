...
declare global {
    var LING_H5_GAME_SDK: any;
}
declare class SdkH5Simo extends SdkCommon {
    ...
    private login;
    logout(): void;
    upRole(params: H5SimoUpRoleParam): void;
    pay(params: H5SimoPayParam, callback: H5MethodParams): Promise<void>;
    private share;
